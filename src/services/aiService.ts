  ...
  try {
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: `Eres el asistente virtual de "Segunda Mirada", una plataforma de admisión médica para segundas opiniones en traumatología de mano y miembro superior.
